...
app.layout = dbc.Container([
    ...
    dbc.Row([
        ...
        dbc.Col([
            ...
            dcc.Input(id='ppgoal', type='number', min=0, max=1000, step=0.1, placeholder="Power Play Goal Bonus", value=128.0, debounce=True),
            html.Br(), html.Label('Powerplay Assist'), html.Br(),
            dcc.Input(id='ppassist', type='number', min=0, max=1000, step=0.1, placeholder="Power Play Assist Bonus", value=80.0, debounce=True),
            ...
            dcc.Input(id='shgoal', type='number', min=0, max=1000, step=0.1, placeholder="Short Handed Goal Bonus", value=128.0, debounce=True),
            html.Br(), html.Label('Short Handed Assist'), html.Br(),
            dcc.Input(id='shassist', type='number', min=0, max=1000, step=0.1, placeholder="Short Handed Assist Bonus", value=80.0, debounce=True),
